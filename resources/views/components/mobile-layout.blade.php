    ...
    <div class="mobile-app">
        ...
        <nav class="mobile-bottom-nav">
            ...
            $navItems = [
                ...
                ['route' => 'budgets.index', 'label' => 'Budget', 'pattern' => 'budgets.*', 'icon' => '<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 7h6m0 10v-3m-3 3h.01M9 17h.01M9 11h.01M12 11h.01M15 11h.01M4 19h16a2 2 0 002-2V7a2 2 0 00-2-2H4a2 2 0 00-2 2v10a2 2 0 002 2z"/>'],
