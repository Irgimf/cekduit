...
<x-mobile-auth-layout>
    <div style="min-height:100vh;display:flex;flex-direction:column;background:linear-gradient(160deg,#014BAA 0%,#0166E8 38%,#F0F4F8 38%);">
        <div style="padding:44px 32px 24px;text-align:center;">
