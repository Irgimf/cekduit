<x-app-layout>
    ...
    <div class="py-6">
        <div class="max-w-md mx-auto sm:px-6 lg:px-8">
            <form action="{{ route('incomes.store') }}" method="POST" class="bg-white shadow-sm rounded-lg p-6 space-y-4">
                @csrf
                ...
                <div>
                    ...
                    @if ($categories->isEmpty())
                        <p class="text-amber-600 text-sm mt-1">
                            Belum ada kategori pemasukan. <a href="{{ route('categories.create') }}" class="underline">Buat dulu di sini</a>.
                        </p>
                    @endif
                </div>
