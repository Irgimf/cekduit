<x-onboarding-layout>
    ...
    <div class="ob-content">
        ...
        <div style="text-align:center;padding:20px 0 28px;">
            ...
            <div class="ob-title" style="text-align:center;">Selamat Datang,<br>{{ auth()->user()->name }}! <x-heroicon-o-hand-raised class="w-6 h-6 inline text-yellow-500" style="width:1.2em; height:1.2em;"  /></div>
