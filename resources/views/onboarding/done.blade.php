        ...
        <div style="background:#fff;border-radius:16px;padding:16px;width:100%;margin-bottom:28px;text-align:left;">
            ...
            <div style="display:flex;flex-direction:column;gap:8px;">
                ...
                <div style="display:flex;align-items:center;gap:10px;font-size:13px;color:#64748B;">
                    <span style="width:22px;height:22px;background:#DCFCE7;border-radius:50%;display:flex;align-items:center;justify-content:center;font-size:11px;color:#16a34a;font-weight:700;flex-shrink:0;">✓</span>
