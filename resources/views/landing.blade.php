            ...
            <div class="phone-frame">
                <div class="phone-screen">
                    ...
                    <div class="phone-header">
                        <div class="phone-greeting">Selamat Pagi, <x-heroicon-o-hand-raised class="w-6 h-6 inline text-yellow-500" style="width:1.2em; height:1.2em;"  /></div>
    ...
    <div class="container">
        ...
        <div class="pricing-grid">
            ...
            <div class="pricing-card featured">
                ...
                <div class="pricing-annual"><x-heroicon-o-light-bulb class="w-5 h-5 inline text-yellow-500" style="width:1.2em; height:1.2em;"  /> Hemat 33% — Rp 120.000/tahun</div>
    ...
    <div class="footer-container">
        ...
        <div class="footer-bottom">
            <div class="footer-copy">
                &copy; {{ date('Y') }} CekDuit. Dibuat dengan <x-heroicon-s-heart class="w-5 h-5 inline text-red-500" style="width:1.2em; height:1.2em;"  />️ untuk masyarakat Indonesia.
            </div>
