        ...
        <div class="cd-card" style="padding:40px 32px;text-align:center;">
            ...
            <div style="background:#F8F3F0;border-radius:12px;padding:16px;margin-bottom:24px;text-align:left;">
                ...
                <div style="display:flex;flex-direction:column;gap:8px;">
                    ...
                    <div style="display:flex;align-items:flex-start;gap:10px;font-size:13px;color:var(--muted);">
                        <span style="width:22px;height:22px;background:#22C55E;color:#fff;border-radius:50%;display:flex;align-items:center;justify-content:center;font-size:11px;font-weight:700;flex-shrink:0;"><x-heroicon-o-check class="w-5 h-5 inline text-green-500" style="width:1.2em; height:1.2em;"  /></span>
