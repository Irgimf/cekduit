    ...
    <form method="post" action="{{ route('profile.update') }}"
        ...
        <div style="display:flex;align-items:center;gap:12px;">
            ...
            @if (session('status') === 'profile-updated')
                <p style="font-size:13px;color:var(--green);font-weight:500;"><x-heroicon-o-check class="w-5 h-5 inline text-green-500" style="width:1.2em; height:1.2em;"  /> Tersimpan</p>
            @endif
        </div>
    </form>
</section>
