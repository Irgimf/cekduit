    ...
    <div style="max-width:680px;margin:0 auto;">
        ...
        @if (session('warning'))
            <div style="background:#FEF9C3;border:1px solid #FDE68A;color:#92400E;padding:12px 16px;border-radius:8px;margin-bottom:16px;font-size:14px;">
                <x-heroicon-o-exclamation-triangle class="w-5 h-5 inline text-yellow-500" style="width:1.2em; height:1.2em;"  />️ {{ session('warning') }}
            </div>
        @endif
                ...
                @if (auth()->user()->isPremium())
                    <div style="margin-left:auto;">
                        <div style="background:rgba(34,197,94,0.2);padding:8px 14px;border-radius:10px;font-size:13px;font-weight:600;color:#4ade80;">
                            <x-heroicon-o-check class="w-5 h-5 inline text-green-500" style="width:1.2em; height:1.2em;"  /> Aktif
                        </div>
                    </div>
                @endif
            </div>
        ...
        @else
            ...
            <div class="cd-card" style="padding:28px;text-align:center;background:var(--green-bg);">
                <div style="font-size:40px;margin-bottom:12px;"><x-heroicon-o-sparkles class="w-6 h-6 inline text-yellow-500" style="width:1.2em; height:1.2em;"  /></div>
